...
{
    public class DivtblsController : Controller
    {
        private readonly BookrentalshopContext _context;

        public DivtblsController(BookrentalshopContext context)
        {
            _context = context;
        }
